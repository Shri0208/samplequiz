...
public class Q6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        answer = view.findViewById(R.id.answer6);
        ttsBtn = view.findViewById(R.id.ttsButton6);
        submitBtn = view.findViewById(R.id.submitBtn6);
        txt = view.findViewById(R.id.q6);
