...
public class Q10 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        answer = view.findViewById(R.id.answer10);
        ttsBtn = view.findViewById(R.id.ttsButton10);
        submitBtn = view.findViewById(R.id.submitBtn10);
        txt = view.findViewById(R.id.q10);
