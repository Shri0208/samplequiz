...
public class Q7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        answer = view.findViewById(R.id.answer7);
        ttsBtn = view.findViewById(R.id.ttsButton7);
        submitBtn = view.findViewById(R.id.submitBtn7);
        txt = view.findViewById(R.id.q7);
