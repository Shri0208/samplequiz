...
public class Q9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        answer = view.findViewById(R.id.answer9);
        ttsBtn = view.findViewById(R.id.ttsButton9);
        submitBtn = view.findViewById(R.id.submitBtn9);
        txt = view.findViewById(R.id.q9);
