...
public class Q5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        answer = view.findViewById(R.id.answer5);
        ttsBtn = view.findViewById(R.id.ttsButton5);
        submitBtn = view.findViewById(R.id.submitBtn5);
        txt = view.findViewById(R.id.q5);
