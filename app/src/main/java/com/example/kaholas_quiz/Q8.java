...
public class Q8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        answer = view.findViewById(R.id.answer8);
        ttsBtn = view.findViewById(R.id.ttsButton8);
        submitBtn = view.findViewById(R.id.submitBtn8);
        txt = view.findViewById(R.id.q8);
